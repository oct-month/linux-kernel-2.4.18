...
extern void speakup_register_devsynth(void); /* had to move this out of console_init() */
#endif
...
#if defined(__s390__)		/* Phear the redhat.parm card deck! */
...
extern int max_recursive_link;
static int __init overflowmeharder(char * s)
{
	if (strstr(s,"overflowmeharder"))
		max_recursive_link = 8;
	return 0;
}
__setup("stack",overflowmeharder);
...
#endif
#ifdef CONFIG_SPEAKUP
	speakup_register_devsynth(); /* registers the misc device /dev/synth */
#endif
