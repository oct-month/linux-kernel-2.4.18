...
typedef void battery_hook_fp(unsigned short *, unsigned short *,
		unsigned short *, int *, int *);

extern battery_hook_fp* apm_battery_hook;				 
extern struct semaphore apm_battery_hook_sem;

#define apm_set_battery_hook(hook_function) 	\
	down(&apm_battery_hook_sem);		\
	apm_battery_hook = hook_function; 	\
	up(&apm_battery_hook_sem);		\
	
#define apm_remove_battery_hook(hook_function) 	\
	down(&apm_battery_hook_sem);		\
	apm_battery_hook = NULL;		\
	up(&apm_battery_hook_sem);
#endif
