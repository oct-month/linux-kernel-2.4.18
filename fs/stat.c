...
/*
 * Posix clearly states that i_size only has a meaning for regular files
 * and symlinks. Old linux kernels happened to put the "bytes remaining"
 * in this field for pipes; maintain this behavior.
 */
