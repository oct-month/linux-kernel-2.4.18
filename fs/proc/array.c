...
%lu %lu %lu %lu %lu %lu %lu %lu %d %d\n",
		...
		task->maj_flt,
		task->cmaj_flt,
		(long)hz_to_std(task->times.tms_utime),
		(long)hz_to_std(task->times.tms_stime),
		(long)hz_to_std(task->times.tms_cutime),
		(long)hz_to_std(task->times.tms_cstime),
		priority,
		nice,
		0UL /* removed */,
		(long)hz_to_std(task->it_real_value),
		(long)hz_to_std(task->start_time),
		vsize,
