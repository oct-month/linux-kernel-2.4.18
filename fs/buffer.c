...
/* This is used for software suspend. */
...
int bdflush(void *startup)
{
	...
	for (;;) {
		...
		/*
		 * XXX either tq_bdflush should have a swsusp-related name
		 * XXX and be declared only if CONFIG_SOFTWARE_SUSPEND is set
		 * XXX or it should be run even without it.	--hch
		 */
