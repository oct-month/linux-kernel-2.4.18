...
#define DRIVER_NAME "Compaq SMART2 Driver (v 2.4.22)"
#define DRIVER_VERSION SMART2_DRIVER_VERSION(2,4,22)

/* Embedded module documentation macros - see modules.h */
/* Original author Chris Frantz - Compaq Computer Corporation */
MODULE_AUTHOR("Compaq Computer Corporation");
MODULE_DESCRIPTION("Driver for Compaq Smart2 Array Controllers version 2.4.22");
MODULE_LICENSE("GPL");
