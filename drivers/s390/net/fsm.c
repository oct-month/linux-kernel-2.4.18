...
EXPORT_SYMBOL_NOVERS(init_fsm);
EXPORT_SYMBOL_NOVERS(kfree_fsm);
EXPORT_SYMBOL_NOVERS(fsm_settimer);
EXPORT_SYMBOL_NOVERS(fsm_deltimer);
EXPORT_SYMBOL_NOVERS(fsm_addtimer);
EXPORT_SYMBOL_NOVERS(fsm_modtimer);
EXPORT_SYMBOL_NOVERS(fsm_getstate_str);
