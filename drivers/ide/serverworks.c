/*
 * linux/drivers/ide/serverworks.c		Version 0.5	02 April 2002
 *
...
static int svwks_tune_chipset (ide_drive_t *drive, byte xferspeed)
{
	...
	byte csb5		= ((dev->device == PCI_DEVICE_ID_SERVERWORKS_CSB5IDE) || (dev->device == PCI_DEVICE_ID_SERVERWORKS_CSB6IDE) || (dev->device == PCI_DEVICE_ID_SERVERWORKS_CSB6IDE2)) ? 1 : 0;
...
unsigned int __init pci_init_svwks (struct pci_dev *dev, const char *name)
{
	...
	/* setup CSB5/CSB6 : South Bridge and IDE option RAID */
		 ...
		 (dev->device == PCI_DEVICE_ID_SERVERWORKS_CSB6IDE2)) {
//		unsigned int pioreg = 0;
//		unsigned int dmareg = 0;
